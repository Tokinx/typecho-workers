...
.note-images{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:8px;margin-top:12px}.note-images a{display:block;aspect-ratio:1.35;overflow:hidden;border-radius:3px;background:#eef1f5}.note-images img{width:100%;height:100%;object-fit:cover}.note-images.has-1{grid-template-columns:minmax(0,1fr);max-width:50%}.note-images.has-2{grid-template-columns:repeat(2,minmax(0,1fr))}.note-images.has-3{grid-template-columns:repeat(3,minmax(0,1fr))}.note-media-list{display:flex;flex-direction:column;gap:10px;margin-top:12px}.note-media{display:grid;gap:4px}.note-media video{max-width:50%;border-radius:3px;background:#000;display:block}.note-media audio{max-width:50%;min-width:0;width:50%;display:block}.note-media-name{color:#8a96a8;font-size:12px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
