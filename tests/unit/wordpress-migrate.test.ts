...
describe('WordPress WXR migration', () => {
  ...
  it('remaps posts, pages, notes, comments, terms, media and relationships', () => {
    ...
    expect(dataset.contents[2]).toMatchObject({
      ...
      password: 'p', allowComment: '1', allowFeed: '0', commentsNum: 1,
    });
